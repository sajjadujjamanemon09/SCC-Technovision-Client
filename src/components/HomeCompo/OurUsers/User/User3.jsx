            ...
            <div className="group relative cursor-pointer overflow-hidden bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl sm:mx-auto sm:max-w-sm sm:rounded-lg sm:px-10">
              ...
              <div className="relative">
                ...
                <div className=" pt-5 text-base leading-7 text-gray-600 transition-all duration-300 group-hover:text-white/90">
                  ...
                  <p>
                    <span className="font-semibold">Key Insights: </span>Providing valuable perspectives on handling financial risks and navigating market fluctuations.
                  </p>
                </div>
